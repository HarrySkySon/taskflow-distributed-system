...
│   ├── КУРСОВА_РОБОТА.md      # Курсова робота (буде додано за потреби)
│   ├── lab-reports/           # Всі виконані лабораторні роботи (1-9)
│   └── diagrams/              # Всі диаграми по проєкту
│
